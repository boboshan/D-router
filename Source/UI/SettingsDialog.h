...
namespace dcr
{
    ...
    private:
        ...
        void addIntField (const juce::String& name, int& target, int minVal, int maxVal, const juce::String& unitHint, const juce::String& tooltip);
        void addDoubleField (const juce::String& name, double& target, double minVal, double maxVal, const juce::String& unitHint, const juce::String& tooltip);
        void addFloatField (const juce::String& name, float& target, float minVal, float maxVal, const juce::String& unitHint, const juce::String& tooltip);
        void addUIntComboField (const juce::String& name, unsigned int& target, const juce::StringArray& labels, const std::vector<unsigned int>& values, const juce::String& tooltip);
        ...
        // closest value.
        void addIntChoiceField (const juce::String& name, int& target, const std::vector<int>& values, const juce::String& unitHint, const juce::String& tooltip);
        void addDoubleChoiceField (const juce::String& name, double& target, const std::vector<double>& values, const juce::String& unitHint, const juce::String& tooltip);
        void addHexColorField (const juce::String& name, unsigned int& target, const juce::String& tooltip);
