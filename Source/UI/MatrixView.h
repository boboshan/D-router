...
namespace dcr
{
    ...
    private:
        ...
        {
        public:
            FxChainPopupContent (MatrixView& owner, bool isInput, int primaryCh, std::vector<int> targetChannels);
        ...
        void instantiateAndBroadcast (bool isInput, std::vector<int> channels, int slotIdx, juce::PluginDescription desc);
